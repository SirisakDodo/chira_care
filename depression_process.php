...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT question_id FROM depression_assessment";
    ...
    // บันทึกคะแนนรวมลงในตาราง depression_score_history
    $insertScoreSql = "INSERT INTO depression_score_history (soldier_id, total_score, submitted_at) 
                       VALUES (?, ?, NOW())";
...
<body>
    <div class="container mt-5">
        ...
        <p class="text-center">
            <?php
            if ($totalScore < 20) {
                echo "<span class='text-warning'>คุณมีอาการซึมเศร้าในเบื้องต้น</span>";
            } elseif ($totalScore >= 20 && $totalScore <= 30) {
                echo "<span class='text-info'>คุณมีอาการซึมเศร้าในขั้นปานกลาง</span>";
            } else {
                echo "<span class='text-danger'>คุณมีอาการซึมเศร้าในขั้นรุนแรง</span>";
            }
            ?>
        </p>
