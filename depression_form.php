...
<head>
    ...
    <title>แบบประเมินทดสอบอาการซึมเศร้า</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h3 class="text-center">แบบประเมินทดสอบอาการซึมเศร้า</h3>
        <form id="formqsys" name="formqsys" method="post" action="depression_process.php" class="mt-4">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT question_id, question_text FROM depression_assessment";
