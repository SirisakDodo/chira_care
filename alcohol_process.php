...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT question_id FROM alcohol_assessment";
    ...
    $insertScoreSql = "INSERT INTO alcohol_score_history (soldier_id, total_score, submitted_at)
                       VALUES (?, ?, NOW())";
...
<body>
    <div class="container mt-5">
        ...
        <p class="text-center">
            <?php
            if ($totalScore < 20) {
                echo "<span class='text-warning'>คุณมีอาการติดสุราในเบื้องต้น</span>";
            } elseif ($totalScore >= 20 && $totalScore <= 30) {
                echo "<span class='text-info'>คุณมีอาการติดสุราในขั้นปานกลาง</span>";
            } else {
                echo "<span class='text-danger'>คุณมีอาการติดสุราในขั้นรุนแรง</span>";
            }
            ?>
        </p>
