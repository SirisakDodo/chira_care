...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT question_id FROM drug_assessment";
    ...
    $insertScoreSql = "INSERT INTO drug_score_history (soldier_id, total_score, submitted_at)
                       VALUES (?, ?, NOW())";
...
<body>
    <div class="container mt-5">
        ...
        <p class="text-center">
            <?php
            if ($totalScore < 20) {
                echo "<span class='text-warning'>คุณมีอาการติดสารเสพติดในเบื้องต้น</span>";
            } elseif ($totalScore >= 20 && $totalScore <= 30) {
                echo "<span class='text-info'>คุณมีอาการติดสารเสพติดในขั้นปานกลาง</span>";
            } else {
                echo "<span class='text-danger'>คุณมีอาการติดสารเสพติดในขั้นรุนแรง</span>";
            }
            ?>
        </p>
