...
<head>
    ...
    <title>แบบประเมินทดสอบการฆ่าตัวตาย</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container mt-5">
        <h3 class="text-center">แบบประเมินทดสอบการฆ่าตัวตาย</h3>
        <form id="formqsys" name="formqsys" method="post" action="suicide_process.php" class="mt-4">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT question_id, question_text FROM suicide_assessment";
