...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertScoreSql = "INSERT INTO score_history (soldier_id, total_score, submitted_at)
                       VALUES (?, ?, NOW())";
...
<body>
    <div class="container mt-5">
        ...
        <p class="text-center">
            <?php
            if ($totalScore < 20) {
                echo "<span class='text-warning'>คุณมีอาการเสพติดการสูบบุหรี่ในเบื้องต้น</span>";
            } elseif ($totalScore >= 20 && $totalScore <= 30) {
                echo "<span class='text-info'>คุณมีอาการเสพติดการสูบบุหรี่ในขั้นปานกลาง</span>";
            } else {
                echo "<span class='text-danger'>คุณมีอาการเสพติดการสูบบุหรี่ในขั้นรุนแรง</span>";
            }
            ?>
        </p>
