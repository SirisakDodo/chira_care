                    ...
                    <form method="POST" action="" class="p-4 border rounded shadow-sm bg-light">
                        <div class="row form-section">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="soldier_id_card" name="soldier_id_card" class="form-control" required maxlength="13">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row form-section">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.1" id="weight_kg" name="weight_kg" class="form-control">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-section">
                            <div class="col-md-6">
                                ...
                                <textarea id="medical_allergy_food_history" name="medical_allergy_food_history" class="form-control"></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="underlying_diseases">โรคประจำตัว:</label>
                                <textarea id="underlying_diseases" name="underlying_diseases" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row form-section">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="selection_method" name="selection_method" class="form-control">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="text-center">
                            <button type="submit" name="add_soldier" class="btn btn-primary">เพิ่มข้อมูลทหาร</button>
                        </div>
                    </form>
                </body>
            </div>
